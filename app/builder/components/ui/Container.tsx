...
export const Container = ({
  ...
  const containerStyle = {
    ...
    width: "100%",
    maxWidth: isChildContainer ? (flexBasis ? `${flexBasis}%` : undefined) : containerWidth === "custom" ? `${customWidth}${customWidthUnit}` : containerWidth === "boxed" ? "1400px" : undefined,
